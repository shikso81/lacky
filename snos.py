...
ascii_banner = pyfiglet.figlet_format("LACKY SN0S S0FT")
colored_banner = colored(ascii_banner, color='white')  # Красим в цвет
print(colored_banner)

print(Fore.RED + "слил: @Lackymvd aka KROVAVIEZVERI")
senders = {
...
def handle_complaint(senders, receivers):
    ...
    if choice == "1":
        ...
        if complaint_choice == "1.1":
            ...
            complaint_texts = {
                "1.2": f"Здравствуйте, я выиграл премиум, мне сказали что нужно дать им зайти на аккаунт, я дал им код и пароль, после чего они зашли и выкинули меня с аккаунта, когда я пытаюсь зайти, они меня сразу же выкидывают, помогите пожалуйста, там привязана моя банковская карта,обнулите пожалуйста все сессий или удалите аккаунт,{account_username}, а мой айди, если злоумышленник поменял юзернейм — {Telegram_account_ID}. Пожалуйста, перезагрузите сессии или удалите этот аккаунт, так как у меня там очень много важных данных."
            }
        ...
        print(colored(f"@Lackymvd/krovaviezveri", 'red'))
        return
